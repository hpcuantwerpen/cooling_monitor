...
$description = {
  'digital' => { 
     ...
     54 => { info =>  'filter running hours - maintenance alarm',                                   type => 'SoftAlarm',     value => ['No alarm', 'Alarm'], remark => '' },
     55 => { info =>  'high humidity alarm',                                                        type => 'SoftAlarm',     value => ['No alarm', 'Alarm'], remark => '' },
     56 => { info =>  'low humidity alarm',                                                         type => 'SoftAlarm',     value => ['No alarm', 'Alarm'], remark => '' },
  ...
  'analog' => {
    ...
    157 => { info => 'maximum unir reutrn air control temp - form pCO and pCOe', unit => 'ºC',  remark => '' },
